    ...
    def post(self, request):
        ...
        try:
            ...
            if serializer.is_valid():
                register_send_otp_email(request_email, subject='[OTP] new Registration for SWAAD app')
                serializer.save()
                return Response({'status' : 'Otp has been sent to user\'s email'})
...
def register_send_otp_email(email,subject):
...
#                     })
#                 register_send_otp_email(request_email,subject="[OTP] New Login for Swaad App") 
    ...
    def post(self, request):
        ...
        if request_email:
            ...
            if str(request_otp) == str(otp) and request_email == email:
                ...
                return Response({
                    'verified':True,
                    'status':'OTP verified, user is registered successfully'
                })
            else:
                return Response({
                    'verified':False,
